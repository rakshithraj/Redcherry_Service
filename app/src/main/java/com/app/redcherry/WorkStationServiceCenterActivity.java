...
public class WorkStationServiceCenterActivity  extends AppCompatActivity implements View.OnClickListener, ServiceCenterInterface {
    ...
    private void getMyLocation() {
        ...
        if (Utility.checkGpsEnabled(this)) {
            ...
            final ProgressDialog dialog = new ProgressDialog(WorkStationServiceCenterActivity.this);
            dialog.setMessage(
            ...
            imglocation.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    if (latLag != null) {
                        ...
                        Utility.alertDialog(WorkStationServiceCenterActivity.this, "Location not found");
    ...
    public class SearchLocationAsyncTask extends AsyncTask<Void, Void, LatLng> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(WorkStationServiceCenterActivity.this);
            dialog.setMessage(
        ...
        protected LatLng doInBackground(Void... params) {
            return Utility.getLocationFromAddress(WorkStationServiceCenterActivity.this, query);
        }
        ...
        protected void onPostExecute(LatLng result) {
            ...
            if (result == null) {
                Utility.alertDialog(WorkStationServiceCenterActivity.this, "Please check search location and try  again");
                return;
            }
            lat = result.latitude + "";
        ...
        if (AppGlobal.isNetwork(this)) {
            ...
            connectWebService.setOnServerResponse(new ServerResponse() {
                ...
                public void onServerError() {
                    Utility.alertDialog(WorkStationServiceCenterActivity.this, WorkStationServiceCenterActivity.this.getResources().getString(R.string.please_try));
            ...
            //parameter.put("latitude", "12.9141417");
            //parameter.put("longitude", "74.85595680000006");

            connectWebService.stringPostRequest(Config.WORK_STATION_STEP_LIST, WorkStationServiceCenterActivity.this, parameter);
    ...
    private void pharseServiceCenterListData(String result) {
        ...
        try {
            ...
            if (status.trim().equals(FAILURE)) {
                Utility.alertDialog(WorkStationServiceCenterActivity.this, message);
            } else {
