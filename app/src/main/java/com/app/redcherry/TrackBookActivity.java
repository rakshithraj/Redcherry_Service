...
import com.app.redcherry.Fragments.TrackBookFragment;
...
public class TrackBookActivity extends BaseActivity  {
    ...
    */
    ...
    private void setViewPageAdapter() {
        TrackBookActivity.CategoryAdapter adapter = new TrackBookActivity.CategoryAdapter(getSupportFragmentManager(), CONTENT);
        ...
        if (AppGlobal.isNetwork(this)) {
            ...
            connectWebService.setOnServerResponse(new ServerResponse() {
                ...
                public void onServerError() {
                    Utility.alertDialog(TrackBookActivity.this, TrackBookActivity.this.getResources().getString(R.string.please_try));
    ...
    private void pharseData(String result) {
        ...
        try {
            ...
            if (status.trim().equals(FAILURE)) {
                Utility.alertDialog(TrackBookActivity.this, message);
            } else {
                Gson gson = new Gson();
    ...
    private void callCancelBookingpi(String reason, HistoryInfo historyInfo) {
        if (AppGlobal.isNetwork(this)) {
            ...
            connectWebService.stringPostRequest(Config.CANCEL_BOOKING, TrackBookActivity.this, parameter);
    ...
    class CategoryAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (position == SERVICE)
                return TrackBookFragment.newInstance(serviceHistoryList,Constants.Service);
            else
                return TrackBookFragment.newInstance(carWashHistoryList,Constants.Car_wash);
