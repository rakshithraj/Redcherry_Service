...
public class Crop {
    ...
    private void start(Context context, Fragment fragment, int requestCode) {
     ...
     * @param requestCode requestCode for result
     */
    private void start(Context context, android.support.v4.app.Fragment fragment, int requestCode) {
        fragment.startActivityForResult(getIntent(context), requestCode);
    }
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    private static void pickImage(Context context, Fragment fragment, int requestCode) {
        try {
     ...
     * @param requestCode requestCode for result
     */
    private static void pickImage(Context context, android.support.v4.app.Fragment fragment, int requestCode) {
        try {
            fragment.startActivityForResult(getImagePicker(), requestCode);
        } catch (ActivityNotFoundException e) {
            showImagePickerError(context);
